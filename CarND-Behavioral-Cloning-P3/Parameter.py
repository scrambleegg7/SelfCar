...
class ParametersClass(object):
    ...
    def __init__(self):
        ...
        parser.add_argument('--straight_angle', default=0.1, type=float, help="Remove all training data with steering angle less than this. Useful for getting rid of straight bias")
